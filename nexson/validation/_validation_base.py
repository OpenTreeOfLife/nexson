    ...
    def _validate_id_obj_list_by_schema(self, id_obj_list, vc, group_by_warning=False):
        ...
        for obj_nex_id, obj in id_obj_list:
            ...
            if wrong_type:
                ...
                return error_return('wrong value type according to {s} schema'.format(s=vc.schema_name()))
            ...
            if off_key:
                self._error_event(element_type,
                                  ...
                                  obj_nex_id=obj_nex_id,
                                  key_list=off_key)
                return error_return('missing key(s) according to {s} schema'.format(s=vc.schema_name()))
        if _by_warn_type:
